...
PlayerUI.prototype.renderJoin = function () {
  ...
  this.container.innerHTML = [
    ...
    '  <h1>Game Entry</h1>',
    '  <p class="subtitle">Enter the room code and your name to join</p>',
    '  <div class="join-card">',
    '    <div class="field">',
    '      <label>📋 Room Code</label>',
    '      <input type="text" id="join-code" placeholder="e.g. ABC123" maxlength="6" autocomplete="off" style="text-transform:uppercase;letter-spacing:0.3rem;text-align:center;font-weight:700" />',
    '    </div>',
    '    <div class="field">',
    '      <label>👤 Your Name</label>',
    '      <input type="text" id="join-name" placeholder="Enter nickname" autocomplete="off" />',
    '    </div>',
    '    <button id="join-btn" class="btn btn-primary btn-block btn-lg">Join Game</button>',
